...
@section('header', 'Tambah Reward Baru')
@section('subtitle', 'Buat reward baru yang bisa ditukar dengan koin')
    ...
    <div class="mb-6">
        <div class="flex items-center space-x-3">
            ...
            <div>
                ...
                <p class="text-gray-600">Isi form berikut untuk membuat reward baru</p>
            </div>
        </div>
    </div>
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="3"
                        class="block w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        placeholder="Deskripsi detail tentang reward">{{ old('description') }}</textarea>
                ...
                <div>
                    ...
                    <select id="type" name="type"
                        ...
                        <option value="physical" {{ old('type')=='physical' ? 'selected' : '' }}>Fisik (Hadiah fisik,
                            perlu pengambilan)</option>
                        <option value="digital" {{ old('type')=='digital' ? 'selected' : '' }}>Digital (Hadiah digital,
                            dikirim via kode)</option>
                        <option value="voucher" {{ old('type')=='voucher' ? 'selected' : '' }}>Voucher (Kode voucher
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="coin_cost" name="coin_cost" value="{{ old('coin_cost') }}"
                ...
                <div id="validity-section" class="hidden">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="validity_days" name="validity_days" value="{{ old('validity_days') }}"
                            class="block w-full pl-10 pr-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            placeholder="30" min="1">
                    </div>
                    <p class="mt-1 text-xs text-gray-500">Masa berlaku reward setelah ditukar (hanya untuk
                        digital/voucher)</p>
                </div>
                ...
                <div>
                    ...
                    <div class="mb-4">
                        ...
                        <div id="no-image"
                            class="flex flex-col items-center justify-center w-48 h-48 border-2 border-dashed border-gray-300 rounded-lg bg-gray-50">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="additional_info[condition]"
                                value="{{ old('additional_info.condition') }}"
                        ...
                        <div>
                            ...
                            <input type="text" name="additional_info[brand]" value="{{ old('additional_info.brand') }}"
                                class="block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="additional_info[notes]" rows="2"
                                class="block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                placeholder="Catatan khusus tentang reward ini">{{ old('additional_info.notes') }}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="flex flex-col gap-3 sm:flex-row sm:justify-between">
                    ...
                    <div class="flex space-x-3">
                        ...
                        <button type="submit"
                            ...
                            <i class="mr-2 fa-solid fa-check"></i> Simpan Reward
                        </button>
                    </div>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // Cek jika ada nilai stock yang dikirim dari old data
        const oldStock = "{{ old('stock') }}";
        if (oldStock === '-1' || oldStock === '') {
            // Jika sebelumnya unlimited, set ke unlimited
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            if (unlimitedHiddenInput.value === '1') {
                // Jika unlimited, nonaktifkan input stock biasa dan aktifkan hidden untuk unlimited
                stockInput.disabled = true;
                stockInput.value = '-1';
            }
        });
